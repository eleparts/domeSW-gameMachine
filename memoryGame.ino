...
bool starting = 0, mem_starting = 0;

int delay_time;

int ending1 = 4, ending2 = 5, ending3 = 6, ending4 = 7;       // 각 레벨의 따른 라운드 수 설정
